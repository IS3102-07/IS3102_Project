        ...
        <div role="main" class="main">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <input type="button" value="Accept"  style="min-height: 150px; font-size: 50px;"  onclick="../PickerAcceptJob_Servlet?pickRequestId=<%=pickRequest.getId()%>" class="btn btn-lg btn-primary btn-block">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <input type="button" value="Logout"  style="min-height: 150px; font-size: 50px;" onclick="../PickerLogout_Servlet" class="btn btn-lg btn-primary btn-block">
                        </div>
                    </div>
                    <%}%>
                </div>
