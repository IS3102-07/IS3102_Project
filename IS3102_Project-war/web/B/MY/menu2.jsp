    ...
    <div class="container">
        ...
        <nav>
            <ul class="nav nav-pills nav-top">
                <li>
                    <a href="/IS3102_Project-war/ECommerce_StoresServlet"><i class="icon icon-map-marker"></i>Lokasi Kedai</a>
                </li>
                <li>
        ...
        <nav>
            <ul class="nav nav-pills nav-top">
                ...
                <li>
                    <a href="/IS3102_Project-war/ECommerce_WishListServlet"><i class="icon icon-shopping-cart"></i>Senarai Hajat Saya</a>
                </li>
                <li>
                    <a href="/IS3102_Project-war/B/<%=URLprefix%>memberProfile.jsp"><i class="icon icon-user"></i>Profil</a>
                </li>
                <li>
                    <a href="contactUs.jsp"><i class="icon icon-shopping-cart"></i>Hubungi Kami</a>
                </li>
                <li>
                    <a href="/IS3102_Project-war/ECommerce_LogoutServlet"><i class="icon icon-unlock-alt"></i>Log Keluar</a>
                </li>
            </ul>
            <button class="btn btn-responsive-nav btn-inverse" data-toggle="collapse" data-target=".nav-main-collapse">
                <i class="icon icon-bars"></i>
        ...
        <div class="container">
            <nav class="nav-main mega-menu">
                <ul class="nav nav-pills nav-main" id="mainMenu">
                    <li class="dropdown">
                        <a href="/IS3102_Project-war/ECommerce_AllFurnituresServlet">Perabot</a>
                    </li>
                    <li>
                        <a href="/IS3102_Project-war/ECommerce_AllRetailProductsServlet">Produk Runcit</a>
                    </li>
                    <li>
